...
@section('content_page')
            ...
            <div class="modal-body">
                ...
                <div class="col-sm-12">
                    ...
                    <label>PLC Category</label>
                        ...
                        {{-- <input type="text" class="form-control" name="checked_by" id="txtEditSaCheckedBy" value="JMM" autocomplete= "off" readonly> --}}
    ...
    <!-- DELETE MODAL START -->
    {{-- <div class="modal fade" id="modalDeletePlcCategory">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-dark">
                    <h4 class="modal-title"><i class="fa fa-user"></i> Delete PLC Category</h4>
                    <button type="button" style="color: #fff" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form method="post" id="deletePlcCategoryForm">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <label id="lblDeleteUser" class="text-secondary mt-2">Are you sure you want to delete this PLC Category?</label>
                            <input type="hidden" class="form-control" name="plc_category_id" id="txtDeletePlcCategoryId">
                        </div>
                    </div>
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        <button type="submit" id="btnDeletePlcCategory" class="btn btn-primary"><i id="iBtnDeletePlcCategoryIcon" class="fa fa-check"></i> Delete</button>
                    </div>
                </form>
            </div>
        </div>
