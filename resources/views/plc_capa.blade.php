            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        {{-- <a href = 'export_summary'><button class="btn btn-primary mr-2"><i class="fas fa-file-download"></i> Export Summary</button></a><br> --}}
                        ...
                        <div class="col-lg-12 mx-auto">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    {{-- <div class="form-group">
                                        <label class="col-form-label">Preventive Action:</label>
                                        <textarea type="text" class="form-control" rows="5" name="plc_capa_preventive_action" id="txtPlcCapaPreventiveActionId" autocomplete= "off"></textarea>
                                    </div> --}}
                                    <hr>
