<table>
    ...
    <tr>
        <td rowspan="2">PMI</td>
        <td rowspan="2">YEC Review<br>Date Approved: {{ $result }}</td>
    ...
    {{-- 1st HALF YEAR ASSESSMENT  --}}

        <td>{{ $first_year_assessment_status[0] }}</td>
    ...
    <tr>
        ...
        <td>Shipment Preparation</td>
            ...
            <td>{{ $first_year_assessment_status[1] }}</td>
    ...
    <tr>
        ...
        <td>{{ $first_year_assessment_status[2] }}</td>
    ...
    <tr>
        ...
        <td>Changing Sales Qty. (before invoice issuance)</td>
            ...
            <td>{{ $first_year_assessment_status[3] }}</td>
    ...
    <tr>
        ...
        <td>Invoice Issuance (to YEC)</td>
            ...
            <td>{{ $first_year_assessment_status[4]}}</td>
    ...
    <tr>
        ...
        <td>{{ $first_year_assessment_status[5] }}</td>
            <?php
            if($result != null){
            echo "<td>
    ...
    <tr>
        ...
        <td>Changing Sales Invoices -2</td>
            ...
            <td>{{ $first_year_assessment_status[6] }}</td>
            <?php
            if($result != null){
            echo "<td>
    ...
    <tr>
        ...
        <td>Verifying Monthly Data (With Sakura)</td>
            ...
            <td>{{ $first_year_assessment_status[7] }}</td>
    ...
    <tr>
        ...
        <td>Purchase Orders (to YEC)</td>
            ...
            <td>{{ $first_year_assessment_status[8] }}</td>
            <?php
            if($result != null){
            echo "<td>
    ...
    <tr>
        ...
        <td>P/O Placement to CN, PPS Suppliers</td>
            ...
            <td>{{ $first_year_assessment_status[9] }}</td>
            <?php
            if($result != null){
            echo "<td>
    ...
    <tr>
        ...
        <td>Changing P/Os for CN, PPS Suppliers</td>
            ...
            <td>{{ $first_year_assessment_status[10] }}</td>
    ...
    <tr>
        ...
        <td>Receiving Shipments from YEC</td>
            ...
            <td>{{ $first_year_assessment_status[11] }}</td>
            <?php
            if($result != null){
            echo "<td>
    ...
    <tr>
        ...
        <td>Generation of NG Reports</td>
            ...
            <td>{{ $first_year_assessment_status[12] }}</td>
            <?php
            if($result != null){
            echo "<td>
    ...
    <tr>
        ...
        <td>Handling Correct YEC Invoices</td>
            ...
            <td>{{ $first_year_assessment_status[13] }}</td>
            <?php
            if($result != null){
            echo "<td>
    ...
    <tr>
        ...
        <td>Handling Incorrect YEC Invoices</td>
            ...
            <td>{{ $first_year_assessment_status[14] }}</td>
            <?php
            if($result != null){
            echo "<td>
    ...
    <tr>
        ...
        <td>Vouchering</td>
            ...
            <td>{{ $first_year_assessment_status[15] }}</td>
            <?php
            if($result != null){
            echo "<td>
    ...
    <tr>
        ...
        <td>{{ $first_year_assessment_status[16] }}</td>
            <?php
            if($result != null){
            echo "<td>
    ...
    <tr>
        ...
        <td>E-payments by Dollar</td>
            ...
            <td>{{ $first_year_assessment_status[17] }}</td>
    ...
    <tr>
        ...
        <td>{{ $first_year_assessment_status[18] }}</td>
            <?php
            if($result != null){
            echo "<td>
    ...
    <td>{{ $first_year_assessment_status[19] }}</td>
        <?php
            if($result != null){
            echo "<td>
...
{{-- 1st HALF YEAR ASSESSMENT  --}}
    ...
    <td>{{ $first_year_assessment_status[20] }}</td>
    <?php
        if($result != null){
        echo "<td>
...
{{-- 1st HALF YEAR ASSESSMENT  --}}
    ...
    <td>{{ $first_year_assessment_status[21] }}</td>
    <?php
        if($result != null){
        echo "<td>
...
{{-- 1st HALF YEAR ASSESSMENT  --}}
    ...
    <td>{{ $first_year_assessment_status[22] }}</td>
    <?php
        if($result != null){
        echo "<td>
...
{{-- 1st HALF YEAR ASSESSMENT  --}}
    ...
    <td>{{ $first_year_assessment_status[23] }}</td>
    <?php
        if($result != null){
        echo "<td>
...
{{-- 1st HALF YEAR ASSESSMENT  --}}
    ...
    <td>{{ $first_year_assessment_status[24] }}</td>
    <?php
        if($result != null){
        echo "<td>
...
{{-- 1st HALF YEAR ASSESSMENT  --}}
    ...
    <td>{{ $first_year_assessment_status[25] }}</td>
    <?php
        if($result != null){
        echo "<td>
...
{{-- 1st HALF YEAR ASSESSMENT  --}}
    ...
    <tr>
        ...
        <td>Receiving Shipments from CN, PPS Suppliers</td>
            ...
            <td>{{ $first_year_assessment_status[26] }}</td>
            <?php
        if($result != null){
        echo "<td>
    ...
    <tr>
        ...
        <td>Physical Count-PPS</td>
            ...
            <td>{{ $first_year_assessment_status[27] }}</td>
            <?php
        if($result != null){
        echo "<td>
    ...
    <tr>
        ...
        <td>{{ $first_year_assessment_status[28] }}</td>
        <?php
        if($result != null){
        echo "<td>
    ...
    <tr>
        ...
        <td>Handling Discrepancies to CN, PPS</td>
            ...
            <td>{{ $first_year_assessment_status[29] }}</td>
            <?php
        if($result != null){
        echo "<td>
    ...
    <tr>
        ...
        <td>Inventory Valuation</td>
            ...
            <td>{{ $first_year_assessment_status[30] }}</td>
        <?php
            if($result != null){
                echo "<td>
    ...
    <tr>
        ...
        <td>Correcting Monthly Data</td>
            ...
            <td>{{ $first_year_assessment_status[31] }}</td>
            <?php
            if($result != null){
                echo "<td>
    ...
    <tr>
        ...
        <td>Handling of Discrepancies to CN, PPS</td>
            ...
            <td>{{ $first_year_assessment_status[32] }}</td>
            <?php
            if($result != null){
                echo "<td>
    ...
    <tr>
        ...
        <td>Sales from PPS to TS, CN</td>
            ...
            <td>{{ $first_year_assessment_status[33] }}</td>
            <?php
            if($result != null){
                echo "<td>
    ...
    <tr>
        ...
        <td>Daily Cash in Bank Monitoring</td>
            ...
            <td>{{ $first_year_assessment_status[34] }}</td>
            <?php
            if($result != null){
                echo "<td>
    ...
    <tr>
        ...
        <td>{{ $first_year_assessment_status[35] }}</td>
        <?php
            if($result != null){
                echo "<td>
