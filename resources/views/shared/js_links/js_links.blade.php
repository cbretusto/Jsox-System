...
<script src="{{ asset('public/js/my_js/Department.js?n=1') }}"></script>
<script src="{{ asset('public/js/my_js/FiscalYear.js?n=2') }}"></script>
...
<script src="{{ asset('public/js/my_js/PlcModules.js?n=12') }}"></script>
<script src="{{ asset('public/js/my_js/PlcModulesFlowChart.js?n=1') }}"></script>
<script src="{{ asset('public/js/my_js/PlcModulesRCM.js?n=6') }}"></script>
<script src="{{ asset('public/js/my_js/PlcModuleSaData.js?n=3') }}"></script>
...
<script src="{{ asset('public/js/my_js/ClcEvidences.js?n=1') }}"></script>
<script src="{{ asset('public/js/my_js/ClcCategoryPmiClc.js?n=4') }}"></script>
<script src="{{ asset('public/js/my_js/ClcCategoryPmiFcrp.js?n=8') }}"></script>
<script src="{{ asset('public/js/my_js/ClcCategoryPmiItClc.js?n=7') }}"></script>
