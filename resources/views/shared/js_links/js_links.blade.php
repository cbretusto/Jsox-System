...
<script src="{{ asset('public/js/my_js/PlcEvidences.js?n=1') }}"></script>
<script src="{{ asset('public/js/my_js/JsoxPlcMatrix.js?n=1') }}"></script>
<script src="{{ asset('public/js/my_js/Matrix.js?n=2') }}"></script>
<script src="{{ asset('public/js/my_js/PlcModules.js?n=1') }}"></script>
...
<script src="{{ asset('public/js/my_js/PlcModuleSaData.js?n=6') }}"></script>
