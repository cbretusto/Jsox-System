                ...
                <div class="col">
                    ...
                    {{-- <select id="selectGraphToDisplayId" name="select_graph_to_display">
                        <option disabled selected>Select Graph to Display</option>
                                    ...
                                    <option value="Warehouse-TS/CN">Warehouse-TS/CN</option>
                                    <option value="PPS (Prod'n)">PPS (Prod'n)</option>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content"> 
                    ...
                    <form id="formAddAuditFindings">
                        @csrf
                        <div class="modal-body">
                            <input type="text" class="form-control mb-2" id="txtAddYear" name="add_year" placeholder="Year" value="@php echo Date("Y"); @endphp" readonly>
