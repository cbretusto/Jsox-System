                            ...
                            <div class="col-sm-12">
                                ...
                                {{-- <div class="row">
                                    <div class="form-group col-sm-6 flex-column d-flex">
                                        <input type="text" class="form-control" name="current_year" id="txtCurrentYear" value="@php echo date("Y"); @endphp" readonly>
                                    </div>
                                    <div class="form-group col-sm-6 flex-column d-flex">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#addEditRowReasonForRevision').click(function(){
                ...
                var html = '<div class="divEditReasonForRevisionHeader_'+editReasonForRevisionCounter+' pt-2"><span class="badge badge-secondary"> # '+ editReasonForRevisionNumberPerRow +'.</span> <label></label></div>';
                    ...
                    html += '           <textarea class="form-control" rows="3" id="txtEditReasonForRevision_'+editReasonForRevisionCounter+'" name="reason_for_revision_'+editReasonForRevisionCounter+'"></textarea>';
                    html += '       <div>';
                    html += '   </div>';
