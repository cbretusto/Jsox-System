                    ...
                    for ($i=0; $i <count($plc_category); $i++) { 
                        ...
                        for ($y=0; $y <count($get_control_id) ; $y++) { 
                            ...
                            if($i == $get_control_id[$y]->category){
                                ...
                                $event->sheet->setCellValue('E'.$start_col_aff, implode(PHP_EOL, $affected_internal_ctrl_arr));
                    ...
                    for ($i=0; $i <count($plc_category); $i++) { 
                        ...
                        for ($z=0; $z <count($get_2nd_half_id) ; $z++) { 
                            ...
                            if($i == $get_2nd_half_id[$z]->category){
                                ...
                                $event->sheet->setCellValue('H'.$start_col_aff, implode(PHP_EOL, $get2nd_affected_ctrl_arr));
