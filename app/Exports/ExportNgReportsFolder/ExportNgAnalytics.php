...
class ExportNgAnalytics implements  FromView, WithTitle, WithEvents, WithCharts
{
    /**
    ...
    */
    ...
    function __construct(
        ...
        public function view(): View {
                ...
                return view('exports.export_ng_analytics', ['date' => $this->date]);
 ...
 */
        ...
        public function charts(){
            ...
            $label      = [new DataSeriesValues('String', 'Analytics!$A$1', null, 1)];
            $categories = [new DataSeriesValues('String', 'Analytics!$B$1:$'.$test.'$2', null, 4)];
            $values     = [new DataSeriesValues('Number', 'Analytics!$B$2:$'.$test.'$2', null, 4)];
