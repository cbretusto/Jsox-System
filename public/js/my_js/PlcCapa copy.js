...
function GetPlcCapaIdToEdit(plcCapaID){
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            // console.log('get_plc_capa_dic_statement_of_findings', get_plc_capa_dic_statement_of_findings)
            // console.log('get_plc_capa_oec_statement_of_findings', get_plc_capa_oec_statement_of_findings)
            // console.log('get_plc_capa_rf_statement_of_findings', get_plc_capa_rf_statement_of_findings)
            ...
            for(let dicadf = 0; dicadf < get_sa_plc_capa[0].plc_sa_dic_assessment_details_findings_details.length; dicadf++){
                // console.log('Statement of Findings', get_sa_plc_capa[0].plc_sa_dic_assessment_details_findings_details);
                if(dicadf < 1){
                    $('#removeRowDicStatementOfFindings')[0].click();
                }else{
                    $('#addRowDicStatementOfFindings')[0].click();
                }
                if(get_sa_plc_capa[0].capa_details[dicadf] == undefined || get_sa_plc_capa[0].capa_details[dicadf].dic_statement_of_findings == null){
                    ...
                    for(let index = 0; index < get_plc_capa_dic_statement_of_findings.length; index++) {
                        if(get_plc_capa_dic_statement_of_findings[index]['in_charge'] != null){
                            ...
                            console.log('DIC In-charge:', get_plc_capa_dic_statement_of_findings[index].in_charge)
                        }
            ...
            for(let rf = 0; rf < get_sa_plc_capa[0].plc_sa_rf_assessment_details_findings_details.length; rf++){
                ...
                if(get_sa_plc_capa[0].capa_details[rf] == undefined || get_sa_plc_capa[0].capa_details[rf].rfa_statement_of_findings == null){
                    ...
                    console.log('IF RFA',get_sa_plc_capa[0].capa_details[rf].assessment_status)
                }else{
                    console.log('ELSE RFA')
                    for (let ondex = 0; ondex < get_plc_capa_rf_statement_of_findings.length; ondex++) {
                        if(get_plc_capa_rf_statement_of_findings[ondex]['in_charge'] != null){
                            ...
                            console.log('RFA In-charge:', get_plc_capa_rf_statement_of_findings[ondex].in_charge)
                        }
                        ...
                        if(get_plc_capa_rf_statement_of_findings[ondex]['capa_analysis_attachment'] != null){
                            ...
                            // console.log('RF CAPA Analysis Attachment null');
                        }
                        ...
                        if(get_plc_capa_rf_statement_of_findings[ondex]['corrective_action_attachment'] != null){
                            ...
                            // console.log('RF CORRECTIVE ACTION null');
                        }
                        ...
                        if(get_plc_capa_rf_statement_of_findings[ondex]['rfa_attachment'] != null){
                            ...
                            // console.log('RF STATEMENT OF FINDINGS Attachment null');
                        }
                    }
                }
            }
